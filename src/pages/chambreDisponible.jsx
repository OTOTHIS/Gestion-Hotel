  ...
  return (
    <section className="text-gray-600 body-font mt-5">
      ...
      <h2 className="text-lg font-bold leading-7 text-gray-900">
              Les chambre disponsible est  {filteredChambres?.length}
            </h2>
        ...
        {
  filteredChambres.map((chambre , index) =>  <div className="lg:w-1/4 md:w-1/2 p-4 w-full" key={index}>
       <h1 className="text-red-500 text-center font-lg my-2">{chambre?.numero}</h1>
      ...
      <div className="mt-4">
        ...
        <h2 className="text-gray-900 title-font text-lg font-medium">{chambre?.type}</h2>
